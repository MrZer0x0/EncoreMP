...
/*
    ...
    Симуляция физики брошенных/упавших предметов.
    Использует getRayCasting() из MWBase::World (доступен в OpenMW 0.47).
    Синхронизирует позиции через TES3MP ObjectList пакеты.
*/
